...
<section class="h-100 h-custom">
  <div class="container h-100 py-5">
        <div class="col">
            ...
            <!--mon panier-->
            <div  style="width:17em;  margin-left: 70%; margin-top:-490em; font-size:12px ">
                <div class="" >
                    <div class="card-body p-4">
                        <div >
                            <div class="row card shadow-2-strong mb-lg-0 " id="monPanier" style="position: fixed; width: 24em; padding-bottom: 3em; padding-top: 3em; ">
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody class="card-body table-responsive p-0" style="height: 275px; ">
