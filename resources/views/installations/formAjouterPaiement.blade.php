...
<div class="container d-flex justify-content-center mt-0">
    <div class="form-container">
        ...
        @endif
        <div class="text-center text-primary">Detail de l'installation</div>
        <div class="card-body table-responsive p-0" style=" font-size: xx-small;" >
            <table class="table table-head-fixed  small">
                ...
                <tbody >
                    <div>
                        <tr>
                            <td>{{$installations->clients->nom?? $installations->nomClient}}</td>
                            <td>{{$installations->numeroClient}}</td>
                            <td>{{$installations->NetAPayer}}</td>
                            <td>{{$installations->montantVerse}}</td>
                            <td>{{$installations->NetAPayer - $installations->montantVerse}}</td>
                            <td>{{$installations->date}}</td>
                            <td>{{$installations->dateLimitePaiement}}</td>
                        </tr>
                    </div>
                </tbody>
            </table>
