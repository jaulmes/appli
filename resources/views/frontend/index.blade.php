                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="#" class="my-auto">
                                <button class="btn btn-primary" style="color: #3e3ee7;">se connecter</button><i class="fas fa-user fa-2x" style="color: #3e3ee7;"></i>
                            </a>
                        </div>
                    </div>
                </nav>
            ...
            <div class="container py-5">
                <div class="tab-class text-center">
                    ...
                    <div class="tab-content">
                        <!------------------->
                        <div id="productCarousel tab-1" class="carousel slide   fade show p-0" data-bs-ride="carousel" data-bs-interval="2500">
                            <div class="carousel-inner row g-4">
                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        ...
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            ...
                                                            <div class="d-flex justify-content-between flex-lg-wrap ">
                                                                <p class="text-dark fs-5 fw-bold mb-0">{{$produit->getPrice()}}</p>
