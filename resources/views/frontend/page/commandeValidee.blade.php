  ...
  <div class="overlay">
    <div class="overlay-content">
      ...
      <div class="btn-group-custom">
        ...
        <a href="{{ route('afficher.commande', $commande->id) }}" target="_blank" class="btn btn-outline-info" title="Afficher les détails de la commande">
          <i class="fa fa-file-alt"></i> Voir détails
        </a>
        <a href="{{ route('telecharger.commande', $commande->id) }}" title="telecharger la commande" class="btn btn-outline-success">
