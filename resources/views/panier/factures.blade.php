...
<body>
    <div class="invoice-container">
        ...
        <div class="ref-proforma">
            ...
            <div class="agent-operant">Agent opérant: <strong>{{ $ventes->user->name ?? $ventes->agentOperant?? '-'}}</strong> </div>
        ...
        <div class="content">
            ...
            <div class="mini-footer" style="text-align:center; margin-left: 5em;">
                ...
                @endif
                <div class="total"> 
                    <span style="margin-bottom: 3em; Z-index: 5; color: black !important; margin-left: 5em;"> Net A Payer <strong style="color:rgb(255, 255, 255); background-color:rgb(9, 161, 75);   padding: 4px 8px; text-align: center; border-radius: 5px;"> <u>{{ $netAPayer}} Francs CFA</u> </strong> </span>
                </div>
