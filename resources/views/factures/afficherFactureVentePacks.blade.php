...
<head>
    ...
    <title>{{ $factures->numeroFacture }} - {{$ventes->numeroClient ?? $ventes->clients->numero?? 'FACTURE VENTE'}}</title>
...
<body>
    <div class="invoice-container">
        ...
        <div class="ref-proforma">
            ...
            <h2 class="proforma-title">FACTURE VENTES</h2>
            <div class="agent-operant">Agent opérant: <strong>{{$ventes->agentOperant?? $ventes->user->name ??  '-'}}</strong> </div>
            <div class="agent-operant" style="margin-top: 1em;">Date: <strong>{{ $ventes->created_at->format('d-m-y')}}</strong> </div>
        </div>
        ...
        <section class="client-info">
            ...
            <div class="client-details-row">
                <div class="client-nom">
                    <p>NOM du client : <strong>{{ $ventes->clients->nom??  '-'}} </strong> </p>
                </div>
                <div class="client-contact">
                    <p>Contacts : <strong> {{$ventes->clients->numero??  '-'}}</strong></p>
                </div>
                <div class="client-adresse">
                    <p>Adresse : <strong>{{$ventes->clients->adresse??  '-'}}</strong> </p>
                </div>
            </div>
        </section>
        ...
        <div class="content">
            ...
            <div class="mini-footer" style="text-align:center; margin-left: 5em;">
                ...
                @endif
                <div class="total"> 
                    <span style="margin-bottom: 3em; Z-index: 5; background-color:grey; color: black !important; margin-left: 20em;"> Net A Payer <strong style="color: #27ae60; background-color: #e9f7ef;"> <u>{{$ventes->netAPayer}} Francs CFA</u> </strong> </span>
                </div>
