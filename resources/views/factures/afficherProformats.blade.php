...
<head>
    ...
    <title>{{ $factures->numeroFacture }} - {{$proformats->numeroClient ?? $proformats->clients->numero}}</title>
    <style>
        body{
            margin-left: 0;
        }
...
<body>
    ...
    <div class="contact">
        ...
        <p style="margin-top: -0.5em;">
            <strong style="margin-left: 24em;">Email :solutionssolergy@gmail.com</strong>
        </p>
        <div style="margin-top: -1em;">
            <p >
                <strong>REF : {{ $factures->numeroFacture }}</strong>  
                <strong style="margin-left: 38em;">date: {{ $proformats->created_at}}</strong>
            </p>
            <div style="display: flex;">
                <div style="margin-bottom: -7em;">
                    <strong >Agent opérant : {{$proformats->agentOperant}}</strong> <br > 
                    <strong >TEL : {{$proformats->user->numero}}</strong>
                </div>
    ...
    <div class="content">
        ...
        <div class="footer" style="text-align:center">
            ...
            @endif
            <div class="total"> 
                <span style="margin-bottom: 3em; Z-index: 5; background-color:grey; color: black !important"> Net A Payer <strong style="background-color: green;"> <u>{{ $proformats->NetAPayer }} Francs CFA</u> </strong> </span>
            </div>
