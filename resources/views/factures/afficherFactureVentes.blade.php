...
<head>
    ...
    <title>{{ $factures->numeroFacture }} - {{$ventes->numeroClient}}</title>
    <style>
        body{
            margin-left: 0;
        }
        ...
        <div style="margin-top: -1em;">
            ...
            <div style="display: flex;">
                <div style="margin-bottom: -7em;">
                    <strong >Agent opérant : {{$ventes->agentOperant}}</strong> <br > 
                    <strong >TEL : {{$ventes->user->numero}}</strong>
                </div>
                <div style="margin-left: 47em;">
                <h3><strong >client : {{$ventes->nomClient}}</strong></h3> <br>
                    <strong >TEL: {{$ventes->numeroClient}}</strong>
                </div>
            </div>
